...
#if (MOUSE_FOR_MJ_ENABLE||DONGLE_FOR_MJ_ENABLE)
...
//	host
///////////////////////////////////////////////////////////////////////////////
#if (     __PROJECT_DONGLE__ ||__PROJECT_8366_DONGLE_MJ__ || __PROJECT_DONGLE_REMOTE__ || __PROJECT_OTA_MASTER__  ||   \
...
//		u32 t = *((u32 *) (raw_pkt + 8));
		u32 t = *((u32 *)(0x800460));
				...
				t += ((raw_pkt[12] + 8) * 4 + 30) * CLOCK_SYS_CLOCK_1US;
		#else
				t += ((raw_pkt[12] + 8) * 4 + 20) * CLOCK_SYS_CLOCK_1US;
		#endif
		u32 diff = t - clock_time ();
