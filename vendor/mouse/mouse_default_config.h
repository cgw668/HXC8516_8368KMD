...
#define GPIO_BTN_LEFT_RIGHT_FOR_DEBUG      0

#if (GPIO_BTN_LEFT_RIGHT_FOR_DEBUG)
	#define	GPIO10_OUTPUT_ENABLE		1
	#define	GPIO8_OUTPUT_ENABLE			1

	#define DBG_CHN0_LOW		( *(unsigned char *)0x800584 &= (~0x80) )
	#define DBG_CHN0_HIGH		( *(unsigned char *)0x800584 |= 0x80 )
	#define DBG_CHN0_TOGGLE		( *(unsigned char *)0x800584 ^= 0x80 )
	#define DBG_CHN1_LOW		( *(unsigned char *)0x800584 &= (~0x20) )
	#define DBG_CHN1_HIGH		( *(unsigned char *)0x800584 |= 0x20 )
	#define DBG_CHN1_TOGGLE		( *(unsigned char *)0x800584 ^= 0x20 )
#endif
